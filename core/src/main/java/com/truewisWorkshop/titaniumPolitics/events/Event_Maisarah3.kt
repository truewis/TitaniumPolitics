...
@Serializable
class Event_Maisarah3 : EventObject(ReadOnly.questProp("Maisarah3-name"), true), IQuestEventObject {

    @Transient
    override val quest = Quest(
        ReadOnly.questProp("Maisarah3-name"),
        "",
    ...
    override fun exec(a: Int, b: Int) {
        if (parent.player.place.name == "miningHeadquarters" &&
            ...
            parent.eventSystem.add(Event_Maisarah4())
            deactivate()
        }
    }
}
