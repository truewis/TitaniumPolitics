...
@Serializable
data class AppointMeeting(override val sbjCharacter: String, override val tgtPlace: String) : GameAction() {
    ...
    override fun execute() {
        parent.addScheduledMeeting(
            Meeting(meetingTime, Meeting.MeetingType.TALK, who, where)
        )
