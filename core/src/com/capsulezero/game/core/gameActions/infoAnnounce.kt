...
class infoAnnounce(override val tgtCharacter: String, override val tgtPlace: String) : GameAction() {
    ...
    override fun execute() {
        ...
        parent.informations[what]!!.publicity[party] = min((parent.informations[what]!!.publicity[party]?:0)+30, 100)//TODO: match unit of publicity to number of people in the party
