...
//
//            val t = scene2d.table {
//                if (tobj.completed != 0) image((this@CommandUI.stage as CapsuleStage).assetManager.get("data/dev/capsuleDevBoxCheck.png", Texture::class.java)) {
//                    color = Color.GREEN
//                    it.size(36f)
//                } else image((this@CommandUI.stage as CapsuleStage).assetManager.get("data/dev/capsuleDevBox.png", Texture::class.java)) {
//                    color = Color.GREEN
//                    it.size(36f)
//                }
