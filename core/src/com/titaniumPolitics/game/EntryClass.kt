...
class EntryClass : ApplicationAdapter()
{
    ...
    override fun create()
    {
        ...
        com.titaniumPolitics.game.EntryClass.Companion.fontMap.put("fixedsys", nanum)
        gen.dispose()
        val param = SkinLoader.SkinParameter(com.titaniumPolitics.game.EntryClass.Companion.fontMap)
