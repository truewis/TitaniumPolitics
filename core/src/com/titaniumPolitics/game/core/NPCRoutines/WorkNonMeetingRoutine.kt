...
/**
 * The purpose of this routine is that it can be escaped whenever the character is
 * forced into a meeting.
 */
@Serializable
class WorkNonMeetingRoutine(var workplace: String) : Routine() {
