...
//If nothing else to talk about, end the speech. The next speaker is the character with the highest mutuality.
    ...
    override fun endCondition(name: String, place: String): Boolean {
        ...
        return routineStartTime + 7200 / ReadOnly.dt <= gState.time || gState.characters[name]!!.currentMeeting?.let { it.type != Meeting.MeetingType.DIVISION_LEADER_ELECTION } ?: false /*Sometimes characters are transferred between different meetings without their turn. In that case, the previous meeting routine is killed here.*/
    }
}